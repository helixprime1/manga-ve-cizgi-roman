        ...
        <?php if ($success): ?>
            <div class="text-center py-5" data-aos="fade-up">
                ...
                <div class="d-flex gap-3 justify-content-center">
                    <a href="my-content.php" class="btn btn-primary btn-lg">
                        <i class="fas fa-folder-open me-2"></i>İçeriklerim
                    </a>
                    <a href="upload.php" class="btn btn-outline-primary btn-lg">
                        <i class="fas fa-plus me-2"></i>Yeni İçerik Yükle
                    </a>
                </div>
            </div>
        <?php else: ?>
                    ...
                    <div class="card-body p-4">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select form-select-lg" id="type" name="type" required>
                                    ...
                                    <option value="comic" <?php echo (isset($type) && $type === 'comic') ? 'selected' : ''; ?>>
                                        <i class="fas fa-mask"></i> Çizgi Roman
                                    </option>
                                </select>
                            </div>
                        ...
                        <div id="chapterInfo" class="d-none">
                            <div class="alert alert-info">
                                ...
                                Seri seçtiniz. İlk bölümü yükleyebilir, sonraki bölümleri daha sonra ekleyebilirsiniz.
                            </div>
